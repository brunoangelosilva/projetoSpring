...
public class ResumoLancamento {  // Uma projeção do recurso Lançamento, um resumo com os campos "mais importantes" 
								 // dependendo da complexidade do sistema pode haver várias projeções.
	private Long codigo;
